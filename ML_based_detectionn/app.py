...
try:
    ...
    model = None
    print("Warning: ML_model/malwareclassifier-V2.pkl not found. Start the app and place the model file in ML_model/ to enable predictions.")
...
def analyze():
    ...
    if 'file' in request.files:
        ...
        if allowed_file(file.filename):
            if model is None:
                # Model missing - inform user
                return render_template('index.html', error="Model not found. Put 'malwareclassifier-V2.pkl' inside the 'ML_model' folder and restart the app.")
